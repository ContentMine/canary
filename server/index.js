...
var defaultEDOptions = {
  ...
  delete:          false,
  maxSockets:      null,
  input:           Meteor.settings.elastichosts[0]+':'+Meteor.settings.elasticport,
  'input-index':   '_all',
...
var dump = function() {
	...
	var ed = new elasticdump.elasticdump(Meteor.settings.elastichosts[0]+':'+Meteor.settings.elasticport, outfile, defaultEDOptions)
